...
describe('<Agenda />', () => {
  it('should render a welcome message', () => {
    ...
    expect(wrapper.find('Text').at(0).text()).to.equal('Welcome to IITH Senate Search portal- Agenda.');
    expect(wrapper.find('Text').at(1).text()).to.equal('Here you can easily view and track previous Senate Meeting Minutes.');
  });
